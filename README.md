...
Create Battle
curl -X POST http://localhost:3000/battles/create -H "Content-Type: application/json" -d '{"player1": "Ash", "player2": "Misty"}'

Save Battle
curl -X POST http://localhost:3000/battles/save -H "Content-Type: application/json" -d '{
  "id": 1,
  "player1": "Ash",
  "player2": "Misty",
